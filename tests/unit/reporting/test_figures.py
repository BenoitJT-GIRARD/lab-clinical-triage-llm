...
from clinical_triage.reporting.markdown_pdf import _bloc_de_code, _element_de_liste, render
from clinical_triage.reporting.slides import Slide, construire
