...
# Agent de triage médical CHSA — modèle final
...
nom = "BenoitJT-GIRARD/qwen3-1.7b-chsa-triage"
...
```bash
vllm serve BenoitJT-GIRARD/qwen3-1.7b-chsa-triage \
  --revision {{REVISION}} \
...
Dataset [`BenoitJT-GIRARD/chsa-triage-medical-bilingue`](https://huggingface.co/datasets/BenoitJT-GIRARD/chsa-triage-medical-bilingue) :
...
<https://github.com/BenoitJT-GIRARD/chsa-triage>
