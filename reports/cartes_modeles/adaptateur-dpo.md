...
language:
  - fr
  - en
base_model: BenoitJT-GIRARD/qwen3-1.7b-chsa-triage-sft-merged
library_name: peft
tags:
  - medical
  - triage
...
# Agent de triage médical CHSA — adaptateur LoRA (alignement par préférences)

Adaptateur LoRA issu de l'**alignement par préférences (DPO)** du modèle de
triage du CHSA. Il s'applique sur le **modèle supervisé fusionné**, pas sur
...
fusionné](https://huggingface.co/BenoitJT-GIRARD/qwen3-1.7b-chsa-triage)** : il ne
